...
/**
 * Primary content in *ButtonText → Default → Primary*
 */
export interface ButtonTextSliceDefaultPrimary {
  /**
   * Name field in *ButtonText → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: button_text.default.primary.name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  name: prismic.KeyTextField;

  /**
   * Link field in *ButtonText → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: button_text.default.primary.link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link: prismic.LinkField;
}
...
/**
 * Default variation for ButtonText Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ButtonTextSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ButtonTextSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ButtonText*
 */
type ButtonTextSliceVariation = ButtonTextSliceDefault;

/**
 * ButtonText Shared Slice
 *
 * - **API ID**: `button_text`
 * - **Description**: ButtonText
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ButtonTextSlice = prismic.SharedSlice<
  "button_text",
  ButtonTextSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ButtonTextSlice,
      ButtonTextSliceDefaultPrimary,
      ButtonTextSliceVariation,
      ButtonTextSliceDefault,
      ContentIndexSlice,
